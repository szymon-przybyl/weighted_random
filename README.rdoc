...
Generate model with <code>weight</code> and `cumulative_weight` integer attributes:
...
Load weighted randomization stuff into desired model and set accessibillity of `weight` and `cumulative_weight` attributes:
